...
if __name__ == "__main__":
    ...
    for episode in range (num_episodes):
        ...
        print(params[0])
        print("update:")
        print(alpha(episode,alphaValue)*(1/(num_workers*sigma))*sum([eps*F for eps,F in zip(epsilon_W1,reward_workers)]))
        
        params[0] = params[0] + alpha(episode,alphaValue)*(1/(num_workers*sigma))*sum([eps*F for eps,F in zip(epsilon_W1,reward_workers)])
