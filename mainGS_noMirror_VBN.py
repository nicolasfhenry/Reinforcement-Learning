...
numHidden1=14 # 14 neurons per Hidden layer
numHidden2=14
...
if __name__ == "__main__":
    ...
    for episode in range (num_episodes):
        ...
        print(params[0])
        print("update:")
        print(alpha(episode,alphaValue)*(1/(num_workers*sigma))*sum([eps*F*w for eps,F,w in zip(epsilon_W1,reward_workers,fitness)]))
