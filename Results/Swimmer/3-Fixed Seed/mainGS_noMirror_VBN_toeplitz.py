...
def worker_GS(input_worker):
    ...
    epsilon_beta1= epsilon[dim_temp:dim_temp+numHidden1].reshape((numHidden1,1))   
    epsilon_gamma1= epsilon[dim_temp+numHidden1:dim_temp+2*numHidden1].reshape((numHidden1,1))
    epsilon_beta2= epsilon[dim_temp+2*numHidden1:dim_temp+2*numHidden1+numHidden2].reshape((numHidden2,1))
    epsilon_gamma2= epsilon[dim_temp+2*numHidden1+numHidden2:dim_temp+2*numHidden1+2*numHidden2].reshape((numHidden2,1))
...
if __name__ == "__main__":
    ...
    for episode in range (num_episodes):
        ...
        reward_workers,epsilon_W1,epsilon_W2,epsilon_W3,epsilon_gamma1,epsilon_beta1,epsilon_gamma2,epsilon_beta2 =  [list(x) for x in  zip(*main(seeds,epsilons,params))]
